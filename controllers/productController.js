...
const orderBySSLCommerz = async (req, res) => {
  try {
    ...
    const data = {
      ...
      success_url: 'http://localhost:5000/api/v1/product/success',
      fail_url: 'http://localhost:5000/api/v1/product/fail',
      cancel_url: 'http://localhost:5000/api/v1/product/cancel',
